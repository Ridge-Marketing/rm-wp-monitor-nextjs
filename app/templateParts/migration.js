...
const Migration = (props) => {
  ...
  return (
    <section className="pb-1 mb-6 border-b-2 border-solid border-[#F3F9F9]">
      ...
      <p className="leading-6 basic-sans text-lg lg:pr-4 xl:w-[70%] mt-4 block">Developer:</p>
      <p className="text-xl font-bold basic-sans pr-4 block mb-8">{migration.developerName}</p>
